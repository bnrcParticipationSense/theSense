...
public class PMConfig {
	...
	public static final String defaultModelPath = SDPath + "/" + PMHomeName
			+ "/" + defaultModelDirName + "/model1.yml";
	public static final String defaultCrfModelPath = SDPath + "/" + PMHomeName
			+ "/" + defaultModelDirName + "/matmodel.xml";
	public static final String defaultTmpPath = SDPath + "/" + PMHomeName + "/"
			+ defaultTmpDirName + "/";
	...
	public static ModelParams getDefaultModelParams() {
		return new ModelParams(0, 0, defaultStepDiv, defaultBlockDiv,
				defaultBlockScale, defaultModelPath, defaultCrfModelPath,
				defaultTmpPath);
	}
