...
public class PhotoStats {
	...
	public PhotoStats(Float xDirect, Float yDirect, Float zDirect,
			Float longitude, Float latitude, Integer exposureValue,
			Float focalDistance, Float aperture, Integer width, Integer height) {
