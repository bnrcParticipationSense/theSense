...
public abstract class DAOHelper extends SQLiteOpenHelper implements DatabaseConstants {
    ...
    protected static final String[] FILE_ALL_COLUMS = { _ID, FILE_FILE_NAME, FILE_CREATE_TIME, FILE_X_DIRECT, 
    	...
    	FILE_APERTURE, FILE_WIDTH, FILE_HEIGHT, FILE_TAG };
    ...
    protected static final String[] PM_MODEL_ALL_COLUMS = {PM_MODEL_TAG, PM_MODEL_DESC};
    private static final String PM_MODEL_TABLE_CREATE = 
    		"CREATE TABLE " + PM_MODEL_TABLE_NAME + "(" +
    		PM_MODEL_TAG + " INTEGER NOT NULL, " + 
    		PM_MODEL_DESC + " NTEXT, " +
    		"PRIMARY KEY (" + PM_MODEL_TAG + ") " +
    		");";
